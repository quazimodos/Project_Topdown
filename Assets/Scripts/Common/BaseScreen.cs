...
/// The base class all the screens in the game derive from, which provides basic functionality like opening and closing popups. Every scene in the game has an associated screen game object.
